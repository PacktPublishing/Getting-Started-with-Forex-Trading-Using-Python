...
class tradingSystemMetadata:
    def __init__(self):
        ...
        self.list_of_orders = []
        self.orders_buffer = [] # added
        self.number_of_trades = 0 # added
            ...
            try:
                ...
                if order['Status'] == 'Executed':
                    ...
                    if order['Side'] == 'Buy':
                        ...
                        if System.market_position != 0: # introduced, correct calc of nr of trades
                ...
                if order['Status'] == 'Submitted': # introduced this block
                    print('Order submitted', order)
                    System.orders_buffer.append(order)
            except:
                for order in System.orders_buffer: # introduced
                    orders_stream.put(order)
                break
